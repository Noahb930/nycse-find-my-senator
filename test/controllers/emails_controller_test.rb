...
class EmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email" do
    assert_difference('Email.count') do
      post emails_url, params: { email: { content: @email.content, subject: @email.subject } }
    end
  ...
  test "should update email" do
    patch email_url(@email), params: { email: { content: @email.content, subject: @email.subject } }
